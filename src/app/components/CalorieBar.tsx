 ...
 return (
    <div className="bg-neutral-200 border-b border-green-200">
        ...
        <div className="flex border justify-evenly w-11/12 m-auto">
            ...
            <div className=" flex items-center justify-center w-1/3 mx-1 h-7 border border-green-400 rounded text-sm">{calorieCarb}/200c</div>
            <div className=" flex items-center justify-center w-1/3 h-7 border border-green-400 rounded text-sm">{calorieFat}/80f</div>
        </div>
        <div className="my-2">
